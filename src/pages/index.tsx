    ...
    <>
      ...
      <header className="mx-auto my-8 flex h-16 w-4/5 select-none flex-col items-center justify-center font-mono sm:h-32 lg:my-0 lg:h-24 lg:flex-row lg:justify-between">
        <div className="mx-auto flex h-full items-center justify-center text-2xl font-semibold text-red-500">
          <Image alt="cat icon" src="/favicon.ico" width="64" height="64"/>
      ...
      <main className="font-mono">
        ...
        <div className="py-4 items-center justify-center text-center bg-red-400 h-full text-white">
          ...
          <div className="mx-auto w-4/5 lg:w-8/12">
      ...
      <footer className="bg-red-400 flex justify-center items-center py-4 font-mono">
        footer
      </footer>
